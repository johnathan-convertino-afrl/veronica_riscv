...
\par
The Veronica RISCV is a base Vexriscv system. This version of the Vexriscv core emulates the E31 core in its mapping of features.
...
\par
The all Veronica RISCV project source files are written in Verilog 2001. They should synthesize in any modern FPGA software. The core comes as a fusesoc packaged core and can be

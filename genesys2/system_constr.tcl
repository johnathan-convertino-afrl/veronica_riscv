...
set_property -dict { PACKAGE_PIN R28     IOSTANDARD LVCMOS33 } [get_ports { sd_spi_sclk }]; #IO_L9P_T1_DQS_AD7P_35 Sch=sd_sck
set_property -dict { PACKAGE_PIN R29     IOSTANDARD LVCMOS33 } [get_ports { sd_spi_mosi }]; #IO_L16N_T2_35 Sch=sd_cmd
set_property -dict { PACKAGE_PIN R26     IOSTANDARD LVCMOS33 } [get_ports { sd_spi_miso }]; #IO_L16P_T2_35 Sch=sd_dat[0]
set_property -dict { PACKAGE_PIN T30     IOSTANDARD LVCMOS33 } [get_ports { sd_spi_csn }]; #IO_L14N_T2_SRCC_35 Sch=sd_dat[3]

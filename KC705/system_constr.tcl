...
##Micro SD Connector
set_property -dict { PACKAGE_PIN AB23     IOSTANDARD LVCMOS25 } [get_ports { sd_spi_sclk }];
set_property -dict { PACKAGE_PIN AB22     IOSTANDARD LVCMOS25 } [get_ports { sd_spi_mosi }];
